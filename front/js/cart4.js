...
for (i = 0; i < localProducts.length; i++) {
    ...
    console.log("yes", localProducts[0].id)
...
card = card + 
`<article class="cart__item" data-id="${localProducts[i].id}" data-color="${localProducts.color}">
<div class="cart__item__img">
  <img src="${localProducts[i].imageUrl}" alt="${localProducts[i].alt}">
</div>
<div class="cart__item__content">
  <div class="cart__item__content__description">
    <h2>${localProducts[i].name}</h2>
    <p>${localProducts[i].color}</p>
    <p>${totalPrice}</p>
  </div>
